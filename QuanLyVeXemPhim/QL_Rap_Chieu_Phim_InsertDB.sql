...
INSERT INTO ChoNgoi(IDChoNgoi, IDPhong, LoaiChoNgoi, ViTri)
VALUES
('C01P01A1', 'C01P01', N'VIP', N'A1'),
('C01P01A2', 'C01P01', N'VIP', N'A2'),
('C01P01A3', 'C01P01', N'VIP', N'A3'),
('C01P01A4', 'C01P01', N'VIP', N'A4'),
('C01P01A5', 'C01P01', N'VIP', N'A5'),
('C01P02A1', 'C01P02', N'VIP', N'A1'),
('C01P02A2', 'C01P02', N'VIP', N'A2'),
('C01P02A3', 'C01P02', N'VIP', N'A3'),
('C01P02A4', 'C01P02', N'VIP', N'A4'),
('C01P02A5', 'C01P02', N'VIP', N'A5'),
('C01P03A1', 'C01P03', N'VIP', N'A1'),
('C01P03A2', 'C01P03', N'VIP', N'A2'),
('C01P03A3', 'C01P03', N'VIP', N'A3'),
('C01P03A4', 'C01P03', N'VIP', N'A4'),
('C02P01A1', 'C02P01', N'Normal', N'A1'),
('C02P01A2', 'C02P01', N'Normal', N'A2'),
('C02P01A3', 'C02P01', N'Normal', N'A3'),
('C02P02A1', 'C02P02', N'Normal', N'A1'),
('C02P02A2', 'C02P02', N'Normal', N'A2'),
('C02P02A3', 'C02P02', N'Normal', N'A3'),
('C03P01A1', 'C03P01', N'Deluxe', N'A1'),
('C03P01A2', 'C03P01', N'Deluxe', N'A2'),
('C03P01A3', 'C03P01', N'Deluxe', N'A3'),
('C03P01A4', 'C03P01', N'Deluxe', N'A4'),
('C03P01A5', 'C03P01', N'Deluxe', N'A5'),
('C03P02A1', 'C03P02', N'Deluxe', N'A1'),
('C03P02A2', 'C03P02', N'Deluxe', N'A2'),
('C03P02A3', 'C03P02', N'Deluxe', N'A3'),
('C03P02A4', 'C03P02', N'Deluxe', N'A4'),
('C03P02A5', 'C03P02', N'Deluxe', N'A5'),
('C03P03A1', 'C03P03', N'Deluxe', N'A1'),
('C03P03A2', 'C03P03', N'Deluxe', N'A2'),
('C03P03A3', 'C03P03', N'Deluxe', N'A3'),
('C03P03A4', 'C03P03', N'Deluxe', N'A4'),
('C03P03A5', 'C03P03', N'Deluxe', N'A5'),
('C03P04A1', 'C03P04', N'Deluxe', N'A1'),
('C03P04A2', 'C03P04', N'Deluxe', N'A2'),
('C03P04A3', 'C03P04', N'Deluxe', N'A3'),
('C03P04A4', 'C03P04', N'Deluxe', N'A4'),
('C03P04A5', 'C03P04', N'Deluxe', N'A5'),
('C04P01A1', 'C04P01', N'VIP', N'A1'),
('C04P01A2', 'C04P01', N'VIP', N'A2'),
('C04P01A3', 'C04P01', N'VIP', N'A3'),
('C04P01A4', 'C04P01', N'VIP', N'A4'),
('C04P01A5', 'C04P01', N'VIP', N'A5'),
('C04P02A1', 'C04P02', N'VIP', N'A1'),
('C04P02A2', 'C04P02', N'VIP', N'A2'),
('C04P02A3', 'C04P02', N'VIP', N'A3'),
('C04P02A4', 'C04P02', N'VIP', N'A4'),
('C04P02A5', 'C04P02', N'VIP', N'A5'),
('C04P03A1', 'C04P03', N'VIP', N'A1'),
('C04P03A2', 'C04P03', N'VIP', N'A2'),
('C04P03A3', 'C04P03', N'VIP', N'A3'),
('C04P03A4', 'C04P03', N'VIP', N'A4'),
('C04P03A5', 'C04P03', N'VIP', N'A5');
